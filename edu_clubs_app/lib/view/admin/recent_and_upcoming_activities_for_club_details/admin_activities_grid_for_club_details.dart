...
class AdminActivitiesGridView extends StatelessWidget {
  AdminActivitiesGridView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Club Activities Management')),
      body: Padding(
          ...
          builder: (controller) {
            ...
            return GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                var advisorName =
                    category.clubName; // Assuming club name is part of the data
